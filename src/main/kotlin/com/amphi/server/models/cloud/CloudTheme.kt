...
class CloudTheme(
    ...
    val modified: Long,
    val created: Long,
    val lightColors: CloudThemeColors,
    val darkColors: CloudThemeColors
) {
    companion object {
        fun fromResultSet(resultSet: ResultSet) : CloudTheme {
            return CloudTheme(
                id = resultSet.getString("id"),
                title = resultSet.getString("title"),
                modified = resultSet.getLong("modified"),
                created = resultSet.getLong("created"),
                lightColors = CloudThemeColors(
